...
parser.add_argument('-epochs', type=int, action='store', default=15)
...
parser.add_argument('-out_dim', type=int, action='store', default=500)
parser.add_argument('-window_dim', type=int, action='store', default=3)
...
parser.add_argument('-l2', type=float, action='store', default=0.001)
